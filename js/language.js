...
i18n["es"]["has_alopecia"] = true
i18n["es"]["has_aas"] = true
...
i18n["es"]["configuration"].has_alopecia= true
...
i18n["es"]["alopecia_section"] = "斑秃";
i18n["es"]["aas_title"] = "SALT (AAS)";
i18n["es"]["beschreibung_aas"] = "请在下方图像中选择每个头皮区域的脱发百分比。";
i18n["es"]["aas_occipital_title"] = "枕部（24%）";
i18n["es"]["aas_left_temporal_title"] = "左颞部（18%）";
i18n["es"]["aas_right_temporal_title"] = "右颞部（18%）";
i18n["es"]["aas_vertex_title"] = "顶部（40%）";
i18n["es"]["aas_severity_title"] = "斑秃量表（Alopecia Areata Scale, AAS）";
i18n["es"]["aas_factor_psychosocial"] = "斑秃对心理、社会功能产生负面影响";
i18n["es"]["aas_factor_eyebrows"] = "眉毛或睫毛明显受累";
i18n["es"]["aas_factor_treatment"] = "治疗至少6个月后应答不足";
i18n["es"]["aas_factor_rapid"] = "弥漫性（多灶性）阳性毛发拉伸试验表现为快速进展性AA";
i18n["es"]["aas_mild"] = "轻度";
i18n["es"]["aas_moderate"] = "中度";
i18n["es"]["aas_severe"] = "重度";
i18n["es"]["aas_very_severe"] = "极重度";
i18n["es"]["aas_factors"] = "项次要特征";
...
i18n["es"]["scorad-after-body"] = "SCORAD 评分范围为 0-103，分数越高表示疾病越严重。";

i18n["es"]["salt_title"] = "SALT";
i18n["es"]["beschreibung_salt"] = "请在下方图像中选择每个头皮区域的脱发百分比。";
i18n["es"]["salt_occipital_title"] = "枕叶 (24%)";
i18n["es"]["salt_left_temporal_title"] = "左侧颞叶 (18%)";
i18n["es"]["salt_right_temporal_title"] = "右侧颞叶 (18%)";
i18n["es"]["salt_vertex_title"] = "头顶 (40%)";
i18n["es"]["salt_mild"] = "轻度";
i18n["es"]["salt_moderate"] = "中度";
i18n["es"]["salt_severe"] = "重度";
i18n["es"]["salt_very_severe"] = "非常重度";
i18n["es"]["salt_complete"] = "完全脱发";
